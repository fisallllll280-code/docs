...
import SmithdbRunsQueryTraceTotalsBeforePy from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-before-py.mdx';
import SmithdbRunsQueryTraceTotalsAfterPy from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-after-py.mdx';
import SmithdbRunsQueryTraceTotalsBeforeJs from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-before-js.mdx';
import SmithdbRunsQueryTraceTotalsAfterJs from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-after-js.mdx';
import SmithdbRunsQueryTraceTotalsBeforeGo from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-before-go.mdx';
import SmithdbRunsQueryTraceTotalsAfterGo from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-after-go.mdx';
import SmithdbRunsQueryTraceTotalsBeforeKt from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-before-kt.mdx';
import SmithdbRunsQueryTraceTotalsAfterKt from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-after-kt.mdx';
import SmithdbRunsQueryTraceTotalsBeforeSh from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-before-sh.mdx';
import SmithdbRunsQueryTraceTotalsAfterSh from '/snippets/code-samples/smithdb-migration/runs-query-trace-totals-after-sh.mdx';
...
#### List root runs as traces

<Tabs>
  <Tab title="Python">
    If you're calling `client.list_runs(is_root=True)` to enumerate traces, `client.traces.query()` is the dedicated method for that.
  ...
  <Tab title="TypeScript">
    If you're calling `client.listRuns({ isRoot: true })` to enumerate traces, `client.traces.query()` is the dedicated method for that.
...
<Tabs sync={false}>
  ...
  <Tab title="Java">
    If you're calling `client.runs().query()` with `isRoot(true)` to enumerate traces, `client.traces().query()` is the dedicated method for that.
...
<Tabs sync={false}>
  ...
  <Tab title="cURL">
    If you're calling `POST /api/v1/runs/query` with `is_root: true` to enumerate traces, `POST /v2/traces/query` is the dedicated method for that.
...
#### Trace-wide totals move off the root run

<Tabs>
  <Tab title="Python">
    `total_tokens`/`total_cost` are not populated on the root run in v2—`client.traces.query()` exposes them exclusively via `trace_aggregates`.

<Tabs sync={false}>
  <Tab title="Before">
    <SmithdbRunsQueryTraceTotalsBeforePy />
  </Tab>
  <Tab title="After">
    <SmithdbRunsQueryTraceTotalsAfterPy />
  </Tab>
</Tabs>
...
<Tabs sync={false}>
  <Tab title="Before">
    <SmithdbRunsQueryTraceTotalsBeforeJs />
  </Tab>
  <Tab title="After">
    <SmithdbRunsQueryTraceTotalsAfterJs />
  </Tab>
</Tabs>

  </Tab>
  <Tab title="Java">
    `totalTokens()`/`totalCost()` are not populated on the root run in v2—`client.traces().query()` exposes them exclusively via `traceAggregates()`.
...
<Tabs sync={false}>
  <Tab title="Before">
    <SmithdbRunsQueryTraceTotalsBeforeKt />
  </Tab>
  <Tab title="After">
    <SmithdbRunsQueryTraceTotalsAfterKt />
  </Tab>
</Tabs>
...
<Tabs sync={false}>
  <Tab title="Before">
    <SmithdbRunsQueryTraceTotalsBeforeGo />
  </Tab>
  <Tab title="After">
    <SmithdbRunsQueryTraceTotalsAfterGo />
  </Tab>
</Tabs>

  </Tab>
  <Tab title="cURL">
    `total_tokens`/`total_cost` are not populated on the root run in v2—`POST /v2/traces/query` exposes them exclusively via `trace_aggregates`.

<Tabs sync={false}>
  <Tab title="Before">
    <SmithdbRunsQueryTraceTotalsBeforeSh />
  </Tab>
  <Tab title="After">
    <SmithdbRunsQueryTraceTotalsAfterSh />
  </Tab>
</Tabs>
...
<Tip>
See [Traces: query](#traces-query) and [Traces: list runs](#traces-list-runs) below for the full set of trace-oriented methods.
</Tip>
