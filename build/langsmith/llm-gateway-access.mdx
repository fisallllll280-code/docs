...
On any Data Protection policy, you can bock Gateway traces from saving the contents of your LLM call. These traces are not charged against your account's usage totals. 
