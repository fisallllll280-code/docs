...
Add the following values to your `langsmith_config.yaml`, along with the sandbox secret values described above. Replace placeholders with your deployment-specific values.
