...
For Python and TypeScript, the SmithDB-backed methods raise Stainless-generated exceptions instead of the legacy `langsmith.utils` exception classes. Java and Go are unaffected—both SDKs were already Stainless-generated before SmithDB.

<Tabs>
  <Tab title="Python">
    | Before (`langsmith.utils`) | After (`langsmith._openapi_client`) | Notes |
    |---|---|---|
