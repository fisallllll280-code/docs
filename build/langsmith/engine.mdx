...
Each issue has three actions in its toolbar: **Fix**, **Watch**, and **Close**.
...
Click **Fix** to open the fix panel, a two-step workflow:
...
If LangSmith Engine detects a resolved issue recurring in a future trace, the issue is automatically reopened to indicate the problem persists.
