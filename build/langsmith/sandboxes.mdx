...
For self-hosted LangSmith deployments, see [Enable LangSmith Sandboxes on self-hosted deployments](/langsmith/self-host-sandboxes).
...
<Card title="Self-hosted setup" icon="server" href="/langsmith/self-host-sandboxes">
