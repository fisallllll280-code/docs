...
- **[Enable LangSmith Sandboxes](/langsmith/self-host-sandboxes)**: allow users to run code, expose temporary services, and create memory snapshots from self-hosted LangSmith.
