...
| `enable_deployments` | `false` | no | Enable LangGraph Platform Deployments (listener, operator, host-backend). Requires the Deployments license entitlement. |
