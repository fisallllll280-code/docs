...
flowchart LR
    subgraph clients["Clients"]
        direction TB
        browser["Browser"]
        sdk["Client Application<br/>(SDK)"]
        service_urls["Service URLs<br/>(optional)"]
    end

    browser -->|"Bearer token"| lb["Load Balancer<br/>(Customer VPC / Cloud)"]
    sdk -->|"API key"| lb
    service_urls -.-> lb

    subgraph app["LangSmith Application<br/>(Kubernetes release)"]
        direction LR
        frontend["Frontend<br/>(nginx)"]
        platform["Platform Backend"]
        runtime["Sandbox Runtime<br/>(KVM-capable nodes)"]
    ...
    storage["Storage Services<br/>JuiceFS volume + Redis metadata<br/>S3 or GCS bucket"]
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/langsmith/self-host-sandboxes.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
